...
When I was freelancing as an Apple/tech blogger a couple years ago, I have been writing a lot of iOS & OS X app reviews (in Russian). It was always interesting for me to learn in detail about Apple ecosystem and spread the word about all these awesome apps developers are building. 

One thought kept bugging me though, that simply talking about other people’s work is not something that I want to do forever. I knew I should try to build an app myself and the sooner I start working on that, the better. However, I didn’t have any serious programming experience back then and everyone was saying that learning iOS development straight off would be pretty hard. It seemed like a black magic to me at the moment.
...
I has been learning iOS development almost every day, for a couple hours during the evenings, because I  was still working as a freelance blogger and attending high school. Five months later, I had a general idea on how to make fairly simple iOS apps, so I started thinking about my first real project. 
...
<img src="{% asset_path symbols-picker.png %}" alt="symbols-picker" style="width: 450px; "/>
...
Now, I have to admit that was pretty disappointing. When you passionately work on something, you tend to attach a part of yourself to the project, making yourself vulnerable to the critique. That clearly was the case with my first iOS app.
...
After fixing reported bugs and adding some missing characters in  version 1.0.1 soon after the release, I’ve again left Symbols for a few months. I knew there are other great features to add which would improve user experience notably, but I had to focus on my final exams and in the summer I’ve returned back to Lapka.

A lot of users asked me to add a search feature, because scrolling through a long list of symbols (even though categorized) takes too much time. However, this meant to rewrite app structure with Core Data, because my current implementation simply stored symbols in a plain array and it didn’t seem like the best solution for search.
...
I am still pretty new to app development and product making, so take these tips with a grain of salt. Keeping these things in mind helped me greatly, but it may not work as effectively for you.
...
There’re things to improve and little bugs to fix, but generally speaking, I believe that the app is stable and mature enough. And customers agree:

<img src="{% asset_path symbols-rating.png %}" alt="symbols-rating" style="width: 250px;"/>

That’s the story. You can get [Symbols](https://itunes.apple.com/app/symbols/id652475637) on the App Store for 99¢.